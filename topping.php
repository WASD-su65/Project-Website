...
$sql = "SELECT * FROM products WHERE  product_id like 'C%' ORDER BY product_id ASC";
...
<div id="google_translate_element"></div>
  ...
  <div class="container">
    <div class="menubar">
      ...
      <a href="topping.php" class="menubar-items" style="background-color:white; color: #be0029;">
        เครื่องเคียง
      </a>
