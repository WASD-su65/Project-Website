...
$sql = "SELECT * FROM products WHERE  product_id like 'B%' ORDER BY product_id ASC";
...
<head>
  ...
  <title>Striegeln/Main-Menu</title>
...
<div id="google_translate_element"></div>
  ...
  <div class="container">
    <div class="menubar">
      ...
      <a href="mainmenu.php" class="menubar-items" style="background-color:white; color: #be0029;">
        เมนูหลัก
      </a>
