...
$sql = "SELECT * FROM products WHERE  product_id like 'A%' ORDER BY product_id ASC";
...
<head>
  ...
  <title>Striegeln/Promotion</title>
...
<div id="google_translate_element"></div>
  ...
  <div class="container">
    <div class="menubar">
      ...
      <a href="drink.php" class="menubar-items">
        เครื่องดื่ม
      </a>
      <a href="promotion.php" class="menubar-items" style="background-color:white; color: #be0029;">
        ชุดสุดคุ้ม
      </a>
    </div>
    <div class="product">
